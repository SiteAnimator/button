/*
    ...
    function:   Generates a HTML string from JSON
                adds the function generateHtml to the application
...
( function( buttonApp ){
    ...
    buttonApp.service.htmlGeneratorModule = function( ) {        
        // PRIVATE:
        ...
        // FUNCTION: addApplicationsExtensions( void ) void            
            ...
            buttonApp.prependContainer = self.prependContainer;
        
            // add append container
            buttonApp.appendContainer = self.appendContainer;
